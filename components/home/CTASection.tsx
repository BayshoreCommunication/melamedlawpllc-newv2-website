...
const stats = [
  {
    icon: CircleDollarSign,
    title: "Zero Fees",
    subtitle: "Unless Recovery Secured",
  },
  {
    icon: CircleDollarSign,
    title: "Over $100M",
  ...
  },
  {
    icon: Users,
    title: "Thousands",
    subtitle: "of Claims Resolved",
  },
  {
    icon: Scale,
    title: "25+ Years",
    subtitle: "of Proficient Advocacy",
  },
];
        ...
        <div className="relative overflow-hidden rounded-[10px] border border-primary px-6 py-10 sm:px-10 lg:px-16 lg:py-20">
          ...
          <div className="relative z-10 grid grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,720px)_1fr] lg:gap-10">
            <div className="max-w-[720px]">
              ...
              <p className="mt-6 max-w-[620px] text-sm font-medium leading-7 text-white/85 sm:text-base">
                Review how Melamed Law secures the full recovery homeowners and
                businesses are legally owed following denied or underpaid
                insurance claims.
              </p>

              <h3 className="mt-8 text-xl font-bold uppercase text-white sm:text-2xl">
                Never Allow Insurance Companies To
                <span className="text-primary"> Compromise Your Rights</span>
              </h3>

              <p className="mt-3 max-w-[620px] text-sm font-medium leading-7 text-white/85 sm:text-base">
                Insurance companies retain dedicated lawyers, and you are
                entitled to equal advocacy too.
              </p>

              <div className="mt-10 grid max-w-[520px] grid-cols-2 gap-x-8 gap-y-6">
                {stats.map((item, index) => {
                  const Icon = item.icon;
            ...
            <div className="flex min-h-[260px] items-center justify-center lg:min-h-[420px]">
              <Image
                src="/images/home/cta/cta-badge.png"
                alt="We confront the insurance companies so you do not have to."
                width={360}
                height={532}
                className="w-[220px] drop-shadow-[0_24px_45px_rgba(0,0,0,0.45)] sm:w-[280px] lg:w-[300px] xl:w-[340px]"
              />
          ...
          <div className="relative z-10 mt-8 overflow-hidden rounded-[10px] bg-[#08264E]/95 lg:mt-5">
            <div className="grid grid-cols-1 divide-y divide-white/15 lg:grid-cols-[1fr_360px] lg:divide-x lg:divide-y-0">
              <div className="flex items-center gap-4 px-5 py-5 lg:px-10">
                ...
                <p className="text-sm font-medium leading-6 text-white sm:text-base">
                  Insurance companies have legal teams protecting their
                  interests. Make sure you have experienced advocates protecting
                  yours.
                </p>
              </div>

              <div className="flex items-center justify-center px-5 py-5">
                <p className="text-center lg:text-start text-sm font-bold uppercase tracking-wide text-primary sm:text-base">
                  We Confront The Insurance Companies, So You Do Not Have To.
                </p>
              </div>
            </div>
          </div>
